#!/bin/sh
# Create Many TO Many comics vs category
...
maxComicsID(){
    mysql -uroot nowhenati -e "SELECT MAX(comics_id) as id FROM comics_vs_category;";
}
...
echo "Max comics_id in comics_vs_category: $MAX_ID";
if [ -z $PROC_COUNT ]
then 
